...
class Level:
    ...
    def run(self):
        pygame.mixer.music.load("./asset/gamesound.wav")
        ...
        while True:
            ...
            self.level_text(15, f"Tempo: {self.timeout / 1000:.1f}s", (255, 255, 255), (70, 15))
            self.level_text(15, f"FPS: {clock.get_fps():.0f}", (255, 255, 255), (45, 35))
            self.level_text(15, f"Score: {int(self.score)}", (255, 255, 255), (55, 55))
            self.level_text(15, self.name, (255, 255, 0), (50, 75))
